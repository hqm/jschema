...
public class SensoriMotorTest extends TestCase {
	...
	action_hand1_home = new Action(stage,Action.Type.HAND1_HOME.toString(),Action.Type.HAND1_HOME,0);
	action_hand1_up  = new Action(stage,Action.Type.HAND1_UP.toString(),Action.Type.HAND1_UP,1);
	action_hand1_down  = new Action(stage,Action.Type.HAND1_DOWN.toString(),Action.Type.HAND1_DOWN,2);
	action_hand2_home = new Action(stage,Action.Type.HAND2_HOME.toString(),Action.Type.HAND2_HOME,0);
	action_hand2_up  = new Action(stage,Action.Type.HAND2_UP.toString(),Action.Type.HAND2_UP,1);
	action_hand2_down  = new Action(stage,Action.Type.HAND2_DOWN.toString(),Action.Type.HAND2_DOWN,2);
